...
export class RemixMusicSlide extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount = async () => {
    try {
      let musics = await requester.getSync("/song/category/remix");
        ...
        >
          <div className="col-12 slide-wrap">
            ...
            <div ref={this.slideListWrap} className="slide-list-wrap">
              <NavLink to={`/category/remix`} exact={true}>
...
export default RemixMusicSlide;
