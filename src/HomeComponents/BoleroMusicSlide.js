...
export class BoleroMusicSlide extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount = async () => {
    try {
      let musics = await requester.getSync("/song/category/nhac-bolero");
        ...
        >
          <div className="col-12 slide-wrap">
            ...
            <div ref={this.slideListWrap} className="slide-list-wrap">
              <NavLink to={`/category/nhac-bolero`} exact={true}>
...
export default BoleroMusicSlide;
