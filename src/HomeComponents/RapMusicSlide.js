...
export class RapMusicSlide extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount = async () => {
    try {
      let musics = await requester.getSync("/song/category/nhac-rap");
        ...
        >
          <div className="col-12 slide-wrap">
            ...
            <div ref={this.slideListWrap} className="slide-list-wrap">
              <NavLink to={`/category/nhac-rap`} exact={true}>
